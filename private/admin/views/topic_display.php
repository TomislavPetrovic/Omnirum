...
<a href="forum.php?delete_topic_id=<?php echo $topicData['id']; ?>">Izbriši temu</a>
<br><br>
...
?>
	...
	<tr>
		<td><a href="topic.php?id=<?php echo $reply['id_topic']; ?>&delete_reply_id=<?php echo $reply['id']; ?>">Izbriši odgovor</a></td>
	</tr>
</table>
<br>
